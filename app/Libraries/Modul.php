...
class Modul {
    ...
    function getAwalAkhirBulan()
    {
        ...
        return [ 'awal' => $startOfMonth, 'akhir' => $endOfMonth];
    }
    ...
    public function TanggalSekarangF() {
        date_default_timezone_set("Asia/Jakarta");
        return date("d-m-Y");
    }
    ...
    public function enkrip_simple($data) {
        $shift = 4;
        $result = "";
    ...
    public function dekrip_simple($encryptedData) {
        $shift = 4;
    ...
    public function serveImage(ResponseInterface $response, string $filename): ResponseInterface
    {
